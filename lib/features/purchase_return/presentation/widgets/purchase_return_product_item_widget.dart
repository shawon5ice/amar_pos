...
class PurchaseReturnProductListItem extends StatelessWidget {
  const PurchaseReturnProductListItem({super.key, required this.productInfo});


  final PurchaseReturnProduct productInfo;
