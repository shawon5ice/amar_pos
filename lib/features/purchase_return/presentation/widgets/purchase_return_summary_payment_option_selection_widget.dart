...
class PurchaseReturnSummaryPaymentOptionSelectionWidget extends StatefulWidget {
  const PurchaseReturnSummaryPaymentOptionSelectionWidget(
  ...
  @override
  State<PurchaseReturnSummaryPaymentOptionSelectionWidget> createState() =>
      _PurchaseReturnSummaryPaymentOptionSelectionWidgetState();
}

class _PurchaseReturnSummaryPaymentOptionSelectionWidgetState
    extends State<PurchaseReturnSummaryPaymentOptionSelectionWidget> {
  ...
  @override
  void didUpdateWidget(covariant PurchaseReturnSummaryPaymentOptionSelectionWidget oldWidget) {
