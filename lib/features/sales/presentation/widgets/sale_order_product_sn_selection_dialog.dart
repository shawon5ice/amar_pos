...
class SaleOrderProductSnSelectionDialog extends StatefulWidget {
  final SaleProductModel product;
  final ProductInfo productInfo;
  final SalesController controller;

  const SaleOrderProductSnSelectionDialog({
    super.key,
  ...
  @override
  State<SaleOrderProductSnSelectionDialog> createState() =>
      _SaleOrderProductSnSelectionDialogState();
}

class _SaleOrderProductSnSelectionDialogState
    extends State<SaleOrderProductSnSelectionDialog> {
  ...
  void addSN(){
    ...
    widget.controller.update(['sale_order_product_sn_list','sn_input_field']);
  }
