...
class ExchangeProductSnSelectionDialog extends StatefulWidget {
  final ProductModel product;
  final ProductInfo productInfo;
  final ExchangeController controller;

  const ExchangeProductSnSelectionDialog({
    super.key,
  ...
  @override
  State<ExchangeProductSnSelectionDialog> createState() =>
      _ExchangeProductSnSelectionDialogState();
}

class _ExchangeProductSnSelectionDialogState
    extends State<ExchangeProductSnSelectionDialog> {
