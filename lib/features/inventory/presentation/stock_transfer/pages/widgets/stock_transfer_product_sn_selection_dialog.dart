...
class StockTransferProductSnSelectionDialog extends StatefulWidget {
  final StockTransferProduct product;
  final ProductInfo productInfo;
  final StockTransferController controller;

  const StockTransferProductSnSelectionDialog({
    super.key,
  ...
  @override
  State<StockTransferProductSnSelectionDialog> createState() =>
      _PurchaseOrderProductSnSelectionDialogState();
}

class _PurchaseOrderProductSnSelectionDialogState
    extends State<StockTransferProductSnSelectionDialog> {
