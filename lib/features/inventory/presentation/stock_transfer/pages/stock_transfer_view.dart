              ...
              GetBuilder<StockTransferController>(
                ...
                builder: (controller) {
                  WidgetsBinding.instance.addPostFrameCallback((_) {
                    ...
                    controller.update(['selling_party_selection','purchase_order_items']);
                  });
                  return Row(
                    children: [
                      CustomRadioButton(
                      ...
                      builder: (controller) {
                        return TypeAheadField<ProductInfo>(
                                      ...
                                      if (scannedCode != null &&
                                        ...
                                        if (items.length == 1) {
                                          ...
                                          int value = controller
                                              .createStockTransferRequestModel.products
                                              .singleWhere(
                          ...
                          onSelected: (product) {
                            ...
                            i <
                                controller
                                    .createStockTransferRequestModel.products.length;
                            i++) {
                              if (product.id ==
                                  controller
                                      .createStockTransferRequestModel.products[i].id) {
                                value = controller.createStockTransferRequestModel
                                    .products[i].quantity;
                                break;
                              }
                            }
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: GestureDetector(
                                                      ...
                                                      child: controller.isRequisition ?SizedBox.shrink() : GetBuilder<StockTransferController>(
                                                        id: 'sn_status',
                                                        builder: (controller){
                                                          return Container(
                                                            height: 30.h,
