...
//     final icon = hasChildren && !widget.isExpanded ? Icons.folder : hasChildren && widget.isExpanded ? Icons.folder_open : Icons.insert_drive_file;
//
//     return Column(
...
//           selectedTileColor: Colors.grey.shade200, // ✅ Light background fit
...
//             icon,
//             size: 18,
//             color: widget.isExpanded ? Colors.deepOrange : Colors.grey[800], // ✅ Dark grey on light bg
//           ),
//           title: Text(
//             node.data.name,
//             style: TextStyle(
//               fontSize: 13,
//               color: widget.isExpanded ? Colors.deepOrange : Colors.black87, // ✅ Readable on white
...
//                 Container(
//                   width: 2,
//                   color: Colors.grey.shade400, // ✅ Softer line
