...
class ClientLedgerItem extends StatelessWidget {
  ClientLedgerItem({super.key, required this.clientLedgerData,});


  final ClientLedgerData clientLedgerData;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Get.toNamed(ClientLedgerStatementScreen.routeName, arguments: clientLedgerData);
      },
      child: Container(
