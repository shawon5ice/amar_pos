...
class TrialBalanceService {
  static Future<dynamic> getTrialBalance({
    ...
    var response = await BaseClient.getData(
        token: usrToken,
        api: "accounting/report/get-trial-balance-report",
        parameter: query);
    return response;
  }
  ...
  static Future<void> downloadList({required bool isPdf, required String fileName,
    ...
    if(isPdf){
      downloadUrl = "${NetWorkStrings.baseUrl}/accounting/report/download-pdf-trial-balance-report";
    }else{
      downloadUrl = "${NetWorkStrings.baseUrl}/accounting/report/download-excel-trial-balance-report";
    }
