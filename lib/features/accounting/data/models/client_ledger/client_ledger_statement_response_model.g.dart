...
part of 'client_ledger_statement_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ClientLedgerStatementResponseModel _$ClientLedgerStatementResponseModelFromJson(
...
Map<String, dynamic> _$ClientLedgerStatementResponseModelToJson(
        ClientLedgerStatementResponseModel instance) =>
    <String, dynamic>{
...
DataWrapper _$DataWrapperFromJson(Map<String, dynamic> json) => DataWrapper(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => LedgerStatementData.fromJson(e as Map<String, dynamic>))
          .toList(),
...
LedgerStatementData _$LedgerStatementDataFromJson(Map<String, dynamic> json) =>
    LedgerStatementData(
...
Map<String, dynamic> _$LedgerStatementDataToJson(
        LedgerStatementData instance) =>
    <String, dynamic>{
      'date': instance.date,
      'sl_no': instance.slNo,
      'debit': instance.debit,
