...
class PurchaseSummaryPaymentOptionSelectionWidget extends StatefulWidget {
  const PurchaseSummaryPaymentOptionSelectionWidget(
  ...
  @override
  State<PurchaseSummaryPaymentOptionSelectionWidget> createState() =>
      _PurchaseSummaryPaymentOptionSelectionWidgetState();
}

class _PurchaseSummaryPaymentOptionSelectionWidgetState
    extends State<PurchaseSummaryPaymentOptionSelectionWidget> {
  ...
  @override
  void didUpdateWidget(covariant PurchaseSummaryPaymentOptionSelectionWidget oldWidget) {
