...
part of 'return_history_details_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ReturnHistoryDetailsResponseModel _$ReturnHistoryDetailsResponseModelFromJson(
        Map<String, dynamic> json) =>
    ReturnHistoryDetailsResponseModel(
      success: json['success'] as bool,
      data: ReturnHistoryDetailsData.fromJson(
          json['data'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ReturnHistoryDetailsResponseModelToJson(
        ReturnHistoryDetailsResponseModel instance) =>
    <String, dynamic>{
      'success': instance.success,
      'data': instance.data,
    };

ReturnHistoryDetailsData _$ReturnHistoryDetailsDataFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ReturnHistoryDetailsDataToJson(
        ReturnHistoryDetailsData instance) =>
    <String, dynamic>{
      'id': instance.id,
