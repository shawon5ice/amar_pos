...
part 'return_history_details_response_model.g.dart';


@JsonSerializable()
class ReturnHistoryDetailsResponseModel {
  final bool success;
  final ReturnHistoryDetailsData data;

  ReturnHistoryDetailsResponseModel({required this.success, required this.data});

  factory ReturnHistoryDetailsResponseModel.fromJson(Map<String, dynamic> json) => _$ReturnHistoryDetailsResponseModelFromJson(json);
  Map<String, dynamic> toJson() => _$ReturnHistoryDetailsResponseModelToJson(this);
}

@JsonSerializable()
class ReturnHistoryDetailsData {
  final int id;
  ...
  factory ReturnHistoryDetailsData.fromJson(Map<String, dynamic> json) => _$ReturnHistoryDetailsDataFromJson(json);
  Map<String, dynamic> toJson() => _$ReturnHistoryDetailsDataToJson(this);
}
