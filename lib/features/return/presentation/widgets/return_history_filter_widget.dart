                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                addH(8),
                                if(!widget.returnHistory)GetBuilder<FilterController>(
                                    id: 'brand_dd',
                                    builder: (fController) {
                                ...
                                if(!widget.returnHistory)addH(8),
                                if(!widget.returnHistory)GetBuilder<FilterController>(
                                    id: 'category_dd',
                                    builder: (fController) {
                                      return CustomDropdownWithSearchWidget<
