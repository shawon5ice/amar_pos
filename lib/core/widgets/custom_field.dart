...
class _CustomFieldState extends State<CustomField> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: glassMorphismBoxDecoration(color: Colors.grey.shade100),
  ...
  InputBorder getInputBorder() {
    return OutlineInputBorder(
      borderRadius: BorderRadius.circular(widget.brdrRadius ?? 6.0),
      borderSide: BorderSide(
        color: widget.brdrClr ?? Colors.white,
        width: 0,
      ),
    );
  }
